Feature: Display information about the platform
  ...
  Scenario: Show platform details with no other arguments
    ...
    And the output should contain "QA"
    And the output should contain "PROD"
    And the output should contain "role"
    And the output should contain "cui"
    And the output should contain "adminui"
    And the output should contain "api"
    And the output should contain "db"
    And the output should contain "8"
    And the output should contain "26"

  Scenario: Show platform infrastructure details
    ...
    Then the output should contain "tiny"
    Then the output should contain "devweb"
    Then the output should contain "vcenter"
    Then the output should contain "network"
    Then the output should contain "compute"
    Then the output should contain "adminui"
    Then the output should contain "api"
    Then the output should contain "db"
    Then the output should contain "mediumdb"

  Scenario: Show platform infra vcenter details
    ...
    prod:
      ...
      dnsips: *2
    """
  Scenario: Show platform env prod details
