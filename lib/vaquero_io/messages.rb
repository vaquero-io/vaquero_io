...
module VaqueroIo
  ...
  DESC = {
    ...
    cmd_provider_list:        'List all installed provider gems',
    cmd_provider_create:      'Generate template for creating new provider plugin gem',
    cmd_provider_discover:    'List all vaquero_io provider gems on RubyGems',
